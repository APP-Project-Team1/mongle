...
function getIcon(n) {
  return n.icon || ICON_BY_TYPE[n.type] || 'notifications-outline';
}
function getIconColor(n) {
  return n.icon_color ?? '#c97b6e';
}
function getIconBg(n) {
  return n.icon_bg ?? '#fdf4f3';
}
...
export default function CoupleNotificationsScreen() {
...
const styles = StyleSheet.create({
  safeArea: {
    flex: 1,
    // index.jsx의 배경색(#fff)에 맞춤 (planner는 #faf8f5)
    backgroundColor: '#fff',
  },
